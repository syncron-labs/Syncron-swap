    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 mt-16 sm:mt-20">
        ...
        <div className="flex justify-center mb-8 sm:mb-12">
          <div className="bg-slate-900 rounded-2xl p-3 sm:p-6 shadow-xl border border-slate-800 w-full max-w-2xl">
            <div id="debridgeWidget" className="w-full min-h-[600px] sm:min-h-[700px]"></div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          <div className="text-center p-4">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-primary to-lime-400 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Multi-Chain Support</h3>
            <p className="text-gray-400 text-sm sm:text-base">Bridge assets across 25+ supported blockchain networks including Ethereum, Polygon, BSC, and Arbitrum.</p>
          </div>
          ...
          <div className="text-center p-4">
            ...
            <p className="text-gray-400 text-sm sm:text-base">Built on deBridge's secure infrastructure with smart contract validation and decentralized protocols.</p>
          </div>
          ...
          <div className="text-center p-4 sm:col-span-2 lg:col-span-1">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Low Fees</h3>
            <p className="text-gray-400 text-sm sm:text-base">Competitive bridging fees with transparent pricing and no hidden costs for cross-chain transfers.</p>
          </div>
        </div>
